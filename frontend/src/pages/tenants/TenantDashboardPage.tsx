            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Financial overview for this tenant</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Total Paid</span>
                    <span className="font-semibold text-green-600">{formatCurrency(metrics.totalPaid)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Pending Amount</span>
                    <span className="font-semibold text-yellow-600">{formatCurrency(metrics.pendingAmount)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Overdue Amount</span>
                    <span className="font-semibold text-red-600">{formatCurrency(metrics.overdueAmount)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">On-Time Payment Rate</span>
                    <span className="font-semibold">{metrics.onTimePaymentRate}%</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Lease history and current status</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Total Leases</span>
                    <span className="font-semibold">{metrics.totalLeases}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Active Leases</span>
                    <span className="font-semibold text-green-600">{metrics.activeLeaseCount}</span>
                  </div>
                  {metrics.currentLease && (
                    <>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-muted-foreground">Current Rent</span>
                        <span className="font-semibold">{formatCurrency(metrics.currentLease.monthlyRent)}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-muted-foreground">Lease End</span>
                        <span className="font-semibold">{format(new Date(metrics.currentLease.endDate), 'MMM dd, yyyy')}</span>
                      </div>
                    </>
                  )}
                </CardContent>
