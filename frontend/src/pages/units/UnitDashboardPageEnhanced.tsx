    ...
    <div className="unit-dashboard-enhanced">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="dashboard-tabs">
        <TabsList className="tabs-list">
          ...
          <TabsTrigger value="tenants" className="tab-trigger">Tenants</TabsTrigger>
          <TabsTrigger value="utilities" className="tab-trigger">Utilities</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="overview" className="tab-content">
          <div className="content-grid">
            ...
            <Card className="content-card">
              <h2 className="card-title">Occupancy Summary</h2>
              <div className="info-row">
              ...
              <div className="info-row">
                <span className="label">Active Lease:</span>
        ...
        {/* Tenants Tab */}
        <TabsContent value="tenants" className="tab-content">
          {currentTenants && currentTenants.length > 0 ? (
            ...
            <Card className="tenants-card">
              <div className="no-tenants">
                <p className="text-center text-gray-500">No tenants assigned to this unit</p>
              </div>
            </Card>
          )}
        </TabsContent>
        ...
        {/* Utilities Tab */}
        <TabsContent value="utilities" className="tab-content">
