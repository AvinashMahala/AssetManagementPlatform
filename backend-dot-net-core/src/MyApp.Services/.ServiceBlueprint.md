...
*   **Cancellation:** All publicly exposed async methods should accept an optional `CancellationToken cancellationToken = default` and propagate it to downstream calls (repositories, http clients, etc.).
