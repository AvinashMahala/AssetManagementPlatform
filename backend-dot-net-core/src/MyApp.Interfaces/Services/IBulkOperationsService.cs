...
public interface IBulkOperationsService
{
    ...
    Task<object> BulkReceiptsAsync(IEnumerable<Guid> transactionIds, bool regenerateExisting);
    Task<object> BulkCommunicationAsync(IEnumerable<Guid> tenantIds, string subject, string message, IEnumerable<string> channels, IEnumerable<Guid>? attachments);
