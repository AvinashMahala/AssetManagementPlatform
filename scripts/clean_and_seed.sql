-- Clean and Seed Script for Asset Management Platform
-- This script drops all tables and recreates them with fresh schemas
-- Run this with: psql -U asset_user -d asset_management -f scripts/clean_and_seed.sql
...
DROP TABLE IF EXISTS unit_tenants CASCADE;
...
DROP TABLE IF EXISTS password_reset_methods CASCADE;
...
-- Users table (must be first due to foreign keys)
CREATE TABLE users (
...
-- ============================================
-- STEP 4: Seed predefined receipt templates
-- ============================================
