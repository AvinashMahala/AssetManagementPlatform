...
Data is loaded from seed_data_templates.json for easier maintenance
"""
import pandas as pd
import json
import os
...
def load_json_templates():
    ...
    template_file = 'scripts/seed_data_templates.json'
    try:
        with open(template_file, 'r') as f:
            return json.load(f)
    except FileNotFoundError:
        print(f"❌ Template file not found: {template_file}")
        print(f"   Please ensure seed_data_templates.json exists in scripts/ directory")
        return None
