...
def check_prerequisites():
    ...
    required_files = [
        'db-postgres/seeds/python/smart_seed_excel.py',
        'db-postgres/seeds/python/seed_to_db.py',
        'db-postgres/scripts/verify_database.py'
    ]
...
def step1_create_excel():
    ...
    command = "python3 db-postgres/seeds/python/smart_seed_excel.py"
...
def step2_seed_database():
    ...
    command = "python3 db-postgres/seeds/python/seed_to_db.py"
...
def step3_verify_database():
    ...
    command = "python3 db-postgres/scripts/verify_database.py"
