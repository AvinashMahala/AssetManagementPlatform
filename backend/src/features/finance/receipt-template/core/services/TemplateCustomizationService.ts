...
import { PropertyTemplateCustomizationRepository } from '../../data/repository/PropertyTemplateCustomizationRepository';
...
import { TemplateConfiguration, PropertyTemplateCustomization, TemplatePlaceholder } from '@/features/finance/receipt-template/core/types/template-customization.types';
import { PreviewRequest } from '@/features/finance/receipt-template/core/types/template-preview.types';
