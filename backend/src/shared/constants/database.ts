...
export const TABLES = {
  ...
  RENT_TRANSACTION_METER_READINGS: 'rent_transaction_meter_readings',
  TENANT_DOCUMENTS: 'tenant_documents',
  METERS: 'meters',
  METER_READINGS: 'meter_readings',
  RECEIPTS: 'receipts',
  RECEIPT_TEMPLATES: 'receipt_templates',
  PROPERTY_TEMPLATE_CUSTOMIZATIONS: 'property_template_customizations',
...
export const COLUMNS = {
  PROPERTIES: {
    ...
    OWNER_MOBILE_NUMBERS: 'owner_mobile_numbers',
    OWNER_EMAIL_IDS: 'owner_email_ids',
  ...
  RENT_TRANSACTIONS: {
    ...
    RECEIPT_SENT_DATE: 'receipt_sent_date',
    WORKFLOW_COMPLETED_DATE: 'workflow_completed_date',
    NOTES: 'notes',
    CREATED_BY: 'created_by',
    UPDATED_BY: 'updated_by',
    CREATED_AT: 'created_at',
